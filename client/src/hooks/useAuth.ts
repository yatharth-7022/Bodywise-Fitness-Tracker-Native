...
//           }
//           console.log("Initial auth check, token exists:", !!token, "isValid:", isValid);
//         } else {
//           setIsAuthenticated(false);
//           console.log("Initial auth check, token exists: false");
//         }
//       } catch (error) {
...
//         await AsyncStorage.setItem("token", data.token);
//         setIsAuthenticated(true);
//         console.log("Signup successful, isAuthenticated set to:", true);
...
//         });
//       } catch (error) {
//         console.error("Error during signup success:", error);
