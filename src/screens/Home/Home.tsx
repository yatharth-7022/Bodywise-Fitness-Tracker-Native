    ...
    >
      <View className="flex-1 items-center justify-end pb-12">
        ...
        <View className="items-center">
          <Text className="font-extrabold text-2xl text-white">Build Your Fitness</Text>
          <Text className="font-extrabold text-2xl text-white">Start Tracker</Text>
        </View>
        <Text className="font-medium text-white mt-2">Achieve Body Goals</Text>
        <TouchableOpacity
          className="bg-primary rounded-lg px-10 py-2 mt-6"
          onPress={() => navigation.navigate(ROUTES.PRESIGNUP)}
        >
